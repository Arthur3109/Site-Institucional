...
const translations = {
    ...
    pt: {
        ...
        membro1Nome: 'Arthur Emmerich',
        membro1Cargo: 'Front-End',
        membro1Espec: 'Estilização CSS e JS',
        membro2Nome: 'Maria Vitória',
        membro2Cargo: 'Front-End',
        membro2Espec: 'HTML do Site',
        membro3Nome: 'Murilo Caires',
        membro3Cargo: 'Identidade Visual',
        membro3Espec: 'Criação de Logos e Banners',
        membro4Nome: 'Nicolas Miguel',
        membro4Cargo: 'Front-End',
        membro4Espec: 'Criação do Wireframe e Conteudo do site',
        membro5Nome: 'Pedro Lucas',
        membro5Cargo: 'Back-End',
        membro5Espec: 'Criador do Jogo Super Trunfo',
        membro6Nome: 'Rafael',
        membro6Cargo: 'Back-End',
        membro6Espec: 'Criação da Agenda Filosófica',
        membro7Nome: 'Henrique Rodrigues',
        membro7Cargo: 'Back-End',
        membro7Espec: 'Criação da Agenda Filosófica',
        membro8Nome: 'Vinicius Iglesias',
        membro8Cargo: 'Identidade Visual',
        membro8Espec: 'Desing das cartas',
    ...
    en: {
        ...
        teamTitleNew: 'The Thinkers <span>of PITÁGORAS</span>',
        teamSubtitleNew: 'Our team is composed of masters and doctors in philosophy with deep experience in strategic consulting.',
        membro1Nome: 'Arthur Emmerich',
        membro1Cargo: 'Front-End',
        membro1Espec: 'CSS and JS Styling',
        membro2Nome: 'Maria Vitória',
        membro2Cargo: 'Front-End',
        membro2Espec: 'Site HTML',
        membro3Nome: 'Murilo Caires',
        membro3Cargo: 'Visual Identity',
        membro3Espec: 'Creation of Logos and Banners',
        membro4Nome: 'Nicolas Miguel',
        membro4Cargo: 'Front-End',
        membro4Espec: 'Creation of the Wireframe and Website Content',
        membro5Nome: 'Pedro Lucas',
        membro5Cargo: 'Back-End',
        membro5Espec: 'Creator of the Super Trunfo Game',
        membro6Nome: 'Rafael',
        membro6Cargo: 'Back-End',
        membro6Espec: 'Creation of the Philosophical Agenda',
        membro7Nome: 'Henrique Rodrigues',
        membro7Cargo: 'Back-End',
        membro7Espec: 'Creation of the Philosophical Agenda',
        membro8Nome: 'Vinicius Iglesias',
        membro8Cargo: 'Visual Identity',
        membro8Espec: 'Card Design',
    ...
    es: {
        ...
        membro1Nome: 'Arthur Emmerich',
        membro1Cargo: 'Front-End',
        membro1Espec: 'Estilización CSS y JS',
        membro2Nome: 'Maria Vitória',
        membro2Cargo: 'Front-End',
        membro2Espec: 'HTML del Sitio',
        membro3Nome: 'Murilo Caires',
        membro3Cargo: 'Identidad Visual',
        membro3Espec: 'Creación de Logos y Banners',
        membro4Nome: 'Nicolas Miguel',
        membro4Cargo: 'Front-End',
        membro4Espec: 'Creación del Wireframe y Contenido del Sitio',
        membro5Nome: 'Pedro Lucas',
        membro5Cargo: 'Back-End',
        membro5Espec: 'Creador del Juego Super Trunfo',
        membro6Nome: 'Rafael',
        membro6Cargo: 'Back-End',
        membro6Espec: 'Creación de la Agenda Filosófica',
        membro7Nome: 'Henrique Rodrigues',
        membro7Cargo: 'Back-End',
        membro7Espec: 'Creación de la Agenda Filosófica',
        membro8Nome: 'Vinicius Iglesias',
        membro8Cargo: 'Identidad Visual',
        membro8Espec: 'Diseño de las Cartas',
